...
public class CitaDocumentDto {
    ...
    public CitaDocumentDto() {
    }

    public CitaDocumentDto(String id, String titulo, String fecha, String fechaKey, String hora,
                           String lugar, String profesional, String personaEncargada, String observaciones,
                           boolean recordatorioActivo, String createdBy, long createdAt,
